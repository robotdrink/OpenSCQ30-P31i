...
pub const VENDOR_RFCOMM_UUID: Uuid = uuid!("0cf12d31-fac3-4553-bd80-d6832e700000");
pub const VENDOR_RFCOMM_UUID_MASK: Uuid = uuid!("ffffffff-ffff-ffff-ffff-fffffff00000");
