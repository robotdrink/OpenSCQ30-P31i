...
preset-profile = プリセットプロファイル
custom-profile = カスタムプロファイル
import-custom-equalizer-profiles = カスタムプロファイルをインポートする
import-custom-equalizer-profiles-confirm = 同じ名のプロファイルがある場合は上書きします。
export-custom-equalizer-profiles = カスタムプロファイルをエクスポート
export-custom-equalizer-profiles-output = カスタムプロファイルをエクスポートの出力
adaptive = アダプティブ
